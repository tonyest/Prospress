...
<div class="make-bid">
	...
	<p><?php _e('Current Bid: ', 'prospress' ); ?><span id="winning_bid_val"><?php the_winning_bid_value(); ?></span></p>
	<p><?php _e('Winning Bidder: ', 'prospress' ); ?><span id="winning_bidder"><?php the_winning_bidder(); ?></span></p>
	<form id="makebidform" method="get" action="<?php pp_bid_form_action(); ?>">
		<label for="bid_value" class="bid-label"><?php _e('Your max bid', 'prospress' ); ?></label>
