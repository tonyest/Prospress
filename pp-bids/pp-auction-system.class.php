...
class PP_Auction_Bid_System extends PP_Market_System {
	...
	protected function bid_form_fields( $post_id = NULL ) { 
		...
		if (  $post->post_author != $user_ID || $post->post_status == 'private' ) { // viewer is publisher "cannot bid on own auction" or auction status is 'private' and non-functional hide bid form elements
