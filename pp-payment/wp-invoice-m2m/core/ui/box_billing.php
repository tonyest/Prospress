...
The sender of the invoice has not set up any billing options yet.  You cannot make a payment until this is done.  Contact the originator of the invoice to resolve this.
<?php } ?>
