<div class="wrap">
<form method='POST'>
<h2><?php _e("Invoice Settings", WP_INVOICE_TRANS_DOMAIN) ?></h2>
...
<div id="wp_invoice_settings_page" class="wp_invoice_tabbed_content"> 
  ...
  <ul class="wp_invoice_settings_tabs"> 
    <li><a class="selected" href="#selling"><?php _e("Seller Settings") ?></a></li> 
    <li><a href="#buying"><?php _e("Buyer Settings") ?></a></li> 
  </ul>
  ...
  <div id="buying" class="wp_invoice_tab" >
