 <form action="https://www<?php if( $invoice->payee_class->pp_invoice_settings[ 'paypal_sandbox' ] == 'true' ) echo ".sandbox"; ?>.paypal.com/cgi-bin/webscr" method="post" class="clearfix <?php echo $class ?>">
