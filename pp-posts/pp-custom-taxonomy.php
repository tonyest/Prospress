	...
	public function manage_taxonomies( $message = '' ) {
		...
		<div class="wrap">
			            	...
			            	<td valign="top">
								<div class="prospress-actions">
									<ul class="actions-list">
										...
										<li class="action"><a href="<?php echo $edit_types_url; ?>"><?php printf( __( 'Add New %s', 'prospress' ), $tax_type[ 'labels' ][ 'singular_label' ] );?></a></li>
										<li class="action"><a href="<?php echo $edit_types_url; ?>"><?php printf( __( 'Edit %s', 'prospress' ), $tax_type[ 'label' ] );?></a></li>
									</ul>
								</div>	
			            	</td>
						</tr>
			...
			<?php
				...
				<p><?php _e( 'For example, an auction site for 17th Century Dutch Masterpieces might use an <i>Artist</i> taxonomy comprised of the artists <i>Vermeer</i>, <i>Rembrandt</i> and <i>Cuyp</i>.', 'prospress' ) ?></p>
